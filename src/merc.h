...
#define DEM_MOVE		(BIN_0) /* Can roll as an object */
#define DEM_LEAP		(BIN_1) /* Can leap out of someone's hands */
#define DEM_MAGIC		(BIN_2) /* Can cast spells as an object */
#define DEM_LIFESPAN		(BIN_3) /* Can change lifespan */

#define	DEM_GUARDIAN		(BIN_4) /* Can create guardians */
#define	DEM_FEAR		(BIN_5) /* Daimoinon Fear */
#define	DEM_PORTAL		(BIN_6) /* Can create portals */
#define	DEM_CURSE		(BIN_7) /* Make limbs fall off */
#define	DEM_TWIST		(BIN_8)/* Soul Twist */
...
#define IS_BORG(ch)	        ((ch)->class == CLASS_BORG)
...
#define CLAN_LIST	"../misc/clan1.txt"	/* List of clans */
#define ART_LIST	"../misc/art1.txt"	/* List of artifacts */
...
#define BAN_LIST        "../misc/ban.txt"	/* ban */
#define DISABLED_FILE   "../misc/disabled.txt"	/* disabled commands */
#define COPYOVER_FILE   "../misc/copyover.data"	/* copyover data */
#define EXE_FILE        "../src/merc"		/* muds executable */
...
char *	display_demon_changeling	args( ( int c_power, int o_power, int obj_num ) );
...
char *	display_demon_daimoinon		args( ( int c_power, int o_power ) );

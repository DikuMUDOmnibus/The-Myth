...
// was 4, but now all players have it not just mage - Morglum
    {
	"spellproof",		3,
...
/* Morglum : New spell effects (for mage rune spells) */

    {
	"true sight",		99,
	spell_true_sight,	TAR_CHAR_SELF,	POS_STANDING,
	NULL,			SLOT(622),	1000,	12,
	"true sight",		"Your vision returns to normal."
    },

    {
	"aura no magic",	99,
	spell_aura_no_magic,	TAR_CHAR_SELF,	POS_STANDING,
	NULL,			SLOT(623),	1000,	12,
	"",			"Your aura of no magic fades."
    },

    {
	"read aura",		99,
	spell_read_aura,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
	NULL,			SLOT(625),	1000,	12,
	"",			"!Read Aura!"
    },
	...
	NULL,			SLOT(626),	100,	24,
	"",			"!Enchant Armour!"
    },

    {
	"move to hp",		99,
	spell_move_to_hp,	TAR_CHAR_OFFENSIVE,	POS_STANDING,
	NULL,			SLOT(629),	1000,	24,
	"",			"!Move to Hp!"
    },

    {
	"mana to hp",		99,
	spell_mana_to_hp,	TAR_CHAR_SELF,		POS_STANDING,
	NULL,			SLOT(630),	1000,	24,
	"",			"!Mana to hp!"
    },

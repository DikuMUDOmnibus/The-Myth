...
*/
    ...
    { "consent",	do_consent,	POS_STANDING,	 1,  LOG_ALWAYS	},
/*    { "destroy",	do_destroy,	POS_DEAD,	 1,  LOG_NORMAL	}, */
    ...
    { "recall",		do_recall,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "escape",		do_escape,	POS_DEAD,	 3,  LOG_NORMAL	},
    { "/",		do_recall,	POS_STANDING,	 0,  LOG_NORMAL	},
    ...
    { "clandisc",	do_clandisc,	POS_STANDING,	 3,  LOG_NORMAL	},
    ...
    { "cult",		do_coterie,	POS_DEAD,	 3,  LOG_NORMAL	},
...
*/
    ...
    { "obedience",	do_obedience,	POS_STANDING,	 3,  LOG_ALWAYS	},
    ...
    { "paralyze",       do_paralyzing,	POS_FIGHTING,	 3,  LOG_NORMAL	},
    ...
    { "rage",		do_rageme,	POS_FIGHTING,	 3,  LOG_NORMAL	},
...
*/
    ...
    { "colour",         do_color,      POS_STANDING,    4,   LOG_NORMAL   },
    { "magi",         do_color,      POS_STANDING,    4,   LOG_NORMAL   },
    { "learn",          do_learn, POS_STANDING,  4,  LOG_NORMAL   },
    { "apply",          do_apply, POS_STANDING,  3,  LOG_NORMAL   },
    { "selfrestore",    do_selfrestore, POS_DEAD,  3,  LOG_NORMAL   },
    { "mageupkeep",     do_mageupkeep, POS_STANDING,  4,  LOG_NORMAL   },
    { "favourmage",     do_favourmage, POS_STANDING,  6,  LOG_NORMAL   },
    { "teachmast",   do_teachmastery, POS_STANDING,  6,  LOG_NORMAL   },
    { "magetalk",       do_magetalk, POS_FIGHTING, 4,  LOG_NORMAL },
    { "etoken",         do_etoken, POS_STANDING, 3,  LOG_NORMAL },
    { "mageq",          do_mageq, POS_STANDING, 4,  LOG_NORMAL },
    { "ftalk",		do_ftalk,	POS_FIGHTING,	 3,  LOG_NORMAL	},
    { "swetalk",        do_swetalk,	POS_FIGHTING,	 2, LOG_NORMAL	},
    { "]",		do_ftalk,	POS_STANDING,	 3, LOG_NORMAL	},
    { "delete",         do_delete,  POS_STANDING,    3, LOG_NEVER   },
    { "leave",          do_leave,  POS_STANDING,    3, LOG_NEVER   },
    { "ronin",          do_ronin,  POS_STANDING,    3,  LOG_NORMAL   },
    { "anarch",         do_anarch,  POS_STANDING,    3,  LOG_NORMAL   },
    { "bounty",         do_bounty,  POS_STANDING,    3,  LOG_NORMAL   },
    { "afk",            do_afk,  POS_STANDING,    2,  LOG_NORMAL   },
    { "magecom",    do_magecommands,  POS_STANDING,    4,  LOG_NORMAL   },
    { "rolldirt",    do_rolldirt,  POS_STANDING,    2,  LOG_NORMAL   },
    { "wipeslate",    do_clearpks, POS_STANDING, 3,  LOG_ALWAYS },
    { "newbiepack",	do_newbiepack,	POS_STANDING,    0,  LOG_NORMAL },
    { "autostance",	do_autostance,	POS_STANDING,    0,  LOG_NORMAL },

    /*
     * Extra Immortal commands.
     */
    { "makepreg",       do_makepreg,     POS_STANDING,    11,  LOG_ALWAYS   },
    { "allow",		do_allow,	POS_STANDING,	11,  LOG_ALWAYS	},
    { "ban",		do_ban,		POS_STANDING,	11,  LOG_ALWAYS	},
    { "giftset",        do_giftset,  POS_STANDING,   11, LOG_ALWAYS   },
    { "discset",        do_discset,  POS_STANDING,   11, LOG_ALWAYS   },
    { "undeny",         do_undeny,   POS_STANDING,   11, LOG_ALWAYS   },
    { "cset",           do_cset,     POS_STANDING,   11, LOG_ALWAYS   },
    { "resetarea",      do_resetarea, POS_STANDING,  7, LOG_NORMAL    },
    { "dset",           do_dset,  POS_STANDING,   11, LOG_ALWAYS   },
    { "cshow",          do_cshow,   POS_STANDING,  10, LOG_NORMAL   },
    { "pshow",          do_pshow,   POS_STANDING,  10, LOG_NORMAL   },
    { "recolour",       do_recolour, POS_STANDING,   11, LOG_ALWAYS   },
    { "copyover",	do_copyover,	POS_DEAD,	11,  LOG_ALWAYS },
    { "waitplayer",     do_waitplayer, POS_STANDING,  10,  LOG_ALWAYS   },
    { "addlag",         do_addlag, POS_STANDING,  10,  LOG_ALWAYS   },
    { "disable",        do_disable, POS_STANDING,  10,  LOG_ALWAYS   },
    { "renamep",        do_renamep, POS_STANDING,  11,  LOG_ALWAYS   },
    { "unlevel",        do_unlevel, POS_STANDING,  3,  LOG_ALWAYS   },
    { "pstat",          do_pstat,   POS_STANDING,  10, LOG_NORMAL   },
    { "pmort",          do_pmort,   POS_STANDING,  10, LOG_ALWAYS   },
    { "kindness",       do_kindness, POS_STANDING,   11, LOG_ALWAYS   },
    { "pscan",          do_pfilescan, POS_STANDING,   12, LOG_NORMAL   },
    { "lscan",          do_logscan, POS_STANDING,   12, LOG_NORMAL   },
    { "paradox",	      do_paradox,	POS_DEAD,	 9,  LOG_ALWAYS },
    { "pdox",	      do_paradox,	POS_DEAD,	 9,  LOG_ALWAYS },
    { "resetp",	do_resetpassword,	POS_STANDING,	 12,  LOG_NEVER },
    { "info",       do_pinfo, POS_STANDING, 10,  LOG_NORMAL },
    { "idemon",       do_idemon, POS_STANDING, 10,  LOG_NORMAL },
    { "image",       do_image, POS_STANDING, 10,  LOG_NORMAL },
    { "ivamp",       do_ivamp, POS_STANDING, 10,  LOG_NORMAL },
    { "iwolf",       do_itribe, POS_STANDING, 10,  LOG_NORMAL },
    { "itribe",       do_itribe, POS_STANDING, 10,  LOG_NORMAL },
    { "compress",     do_compress, POS_DEAD, 0, LOG_NORMAL },

// END extra immortal commands.

// Extra WereWolf Gift Commands
    { "chill",         do_chill, POS_STANDING, 3,  LOG_NORMAL },
    { "moonbridge",    do_moonbridge, POS_STANDING, 3,  LOG_NORMAL },
    { "gate",          do_gate, POS_STANDING, 3,  LOG_NORMAL },
    { "brew",          do_brew, POS_STANDING, 3,  LOG_NORMAL },
    { "hearttwister",  do_hearttwister, POS_STANDING, 3,  LOG_NORMAL },
    { "grab",          do_grab, POS_STANDING, 3,  LOG_NORMAL },
    { "earthquake",  do_earthquake, POS_FIGHTING, 3,  LOG_NORMAL },
    { "circleattack",  do_circleattack, POS_FIGHTING, 3,  LOG_NORMAL },
    { "minorcreate",  do_minorcreate, POS_STANDING, 3,  LOG_NORMAL },
    { "klaive",        do_klaive, POS_STANDING, 3,  LOG_NORMAL },
    { "entrap",        do_web, POS_STANDING, 3,  LOG_NORMAL },
    { "web",           do_web, POS_STANDING, 3,  LOG_NORMAL },
    { "dazzle",        do_dazzle, POS_STANDING, 3,  LOG_NORMAL },
    { "phase",        do_phase, POS_STANDING, 3,  LOG_NORMAL },

// END Extra WereWolf Gift Commands

// Extra Demon Commands
    { "demonpowers",   do_demonpowers, POS_STANDING, 3,  LOG_NORMAL },
    { "induct",   do_dinduct, POS_STANDING, 3,  LOG_NORMAL },
    { "outcast",   do_doutcast, POS_STANDING, 3,  LOG_NORMAL },
    { "demonweapon",   do_demonweapon, POS_STANDING, 3,  LOG_NORMAL },

// END Extra Demon Commands
...
*/
    ...
    { "slay",		do_slay,	POS_DEAD,	9,  LOG_ALWAYS	},
    ...
    { "quiet",	do_silencedeath,POS_STANDING,	 3,  LOG_NORMAL	},
...
const	struct	xsocial_type	xsocial_table [] =
{
	...
	"On whom do you wish to do this?",
	NULL,
	"You give $S a deep throbbing kiss, rolling your tongue around $S.",
	...
	"On whom do you wish to do this?",
	NULL,
	"You slowly and softly kiss and nuzzle $S neck.",
	...
	"On whom do you wish to do this?",
	NULL,
	"You slowly walk your fingers along $N's naked body.",
	"$n sloyly walks $s fingers along $N's naked body.",
	"$n slowly walks $s fingers along your naked body.",
	"Fun is it? Well you look like a complete fool!",
	NULL,
	0, 0, 0, 5, 5, FALSE
    },
    ...
    {
	"x-strawb",
	"Who do you wish to feed a strawberry to?",
	NULL,
	"You place a strawberry between your lips, and allow $N to slowly eat it.",
	"$n places a strawberry between $s lips, and allows $N to slowly eat it.",
	"$n places a strawberry between $s lips, and allows you to slowly eat it.",
    ...
    {
	"x-blow",
	"In whos ear do you wish to blow in?",
	NULL,
	"You gently blow in $N's ear.",
	"$n gently blows in $N's ear.",
	"$n gently blows in your ear.",
	"You explode.",
	NULL,
	0, 0, 0, 5, 5, FALSE
    },
	...
	NULL,
	"On whom do you wish to do this?",
	"You slowly fondle $N's penis.",
	"$n slowly fondles $N's penis.",
	"$n slowly fondles your penis.",
	"You fondle yourself... Feel better?",
	NULL,
	2, 0, 0, 5, 10, FALSE
    },
    ...
    {
	"xf-jam",
	"Who do you wish to feed jam to?",
	NULL,
	"You smear jam between your breasts, allowing $N to slowly lick it off.",
	"$n smears jam between $s breasts, allowing $N to slowly lick it off.",
	"$n smears jam between $s breasts, allowing you to slowly lick it off.",
	"You eat some jam sandwiches.",
	NULL,
	2, 0, 0, 5, 10, FALSE
    },
    ...
    {
	"xf-lick",
	"Who do you wish to lick?",
	NULL,
	"You lick your tongue across $N's naked chest.",
	"$n licks $s tongue across $N's naked chest.",
	"$n licks $s tongue across your naked chest.",
	...
	"On whom do you wish to do this?",
	NULL,
	"You put your hands between you legs and slowly start to finger yourself for $N.",
	"$n puts $m hands between $m legs and slowly starts to finger themself staring into $N's eyes.",
	"$n puts $m hands between $m legs and fingering herself, softly whispering your name.",
	"Not on yourself!",
	NULL,
	2, 1, 0, 20, 10, FALSE
    },
	...
	"On who?",
	NULL,
	"You take his hard cock in your hand, wrapping your fingers around it and slowly start to pump up and down.",
	"$n takes $N's hard cock in her hands, wrapping her fingers around it as she slowly starts to pump up and down.",
	"$n takes your hard cock into her hands, you moan and shiver with ecstasy as she wraps her fingers around it, slowly pumping up and down.",
	"No.",
	NULL,
	2, 1, 0, 9, 14, FALSE
    },
	...
	"Who do you wish to lick?",
	NULL,
	"You lick your tongue between $N's breasts.",
	"$n licks $s tongue between $N's breasts.",
	"$n licks $s tongue between your breasts.",
	"You stick your tongue out.",
	NULL,
	1, 0, 0, 5, 10, FALSE
    },
	...
	"On whom do you wish to do this?",
	NULL,
	"You take your penis in your hands and begin to jerkoff for $N.",
	"$n takes his hard penis in his hands and begins to jerkoff for $N.",
	"$n starts to moan as he takes his penis into his hands and starts to jerkoff, for your viewing pleasure.",
	"Not on yourself!",
	NULL,
	1, 1, 0, 25, 5, FALSE
    },
...
/*  ROOMTEXT_DATA *rt;
	...
	&&   cmd_table[cmd].level <= trust )
	{
		...
		if (IS_MORE(ch, MORE_MUMMIFIED))
		{
		    ...
		    else if (!str_cmp( cmd_table[cmd].name, "mummify" )) found = TRUE;
		    else
		    {
		...
		else
		{
		    ...
		    else if (!str_cmp( cmd_table[cmd].name, "ctalk"   )) found = TRUE;
		    ...
		    else if (!str_cmp( cmd_table[cmd].name, "ashestoashes")) found = TRUE;
		    else if (!str_cmp( cmd_table[cmd].name, "plasmaform")) found = TRUE;
		    else if (!str_cmp( cmd_table[cmd].name, "who"     )) found = TRUE;
			...
			{
			    if      (!str_cmp( cmd_table[cmd].name, "stake"     )) found = TRUE;
			    else
			    {
		...
		else if (!str_cmp( cmd_table[cmd].name, "astral" )) found = TRUE;
		...
		if      (!str_cmp( cmd_table[cmd].name, "say"  )) found = TRUE;
		...
		else if (!str_cmp( cmd_table[cmd].name, "swetalk" )) found =TRUE;
  		else if (!str_cmp( cmd_table[cmd].name, ":"       ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "vamptalk"))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "vtalk"))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "ctalk"   ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "chat" ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "."    ))found = TRUE;
 		...
 		else if (!str_cmp( cmd_table[cmd].name, "equipment" ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "tell" ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "reply" ))found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "who" )) found= TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "relevel" ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "wake" ))found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "stand" ))found = TRUE;
 		...
 		else if (!str_cmp(cmd_table[cmd].name, "affects" )) found = TRUE;
		else if(!str_cmp( cmd_table[cmd].name, "goto" )) found = TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "where" )) found =TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "burn" )) found =TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "flex" )) found =TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "fcommand" )) found =TRUE;
 		else if (!str_cmp( cmd_table[cmd].name, "[" )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "group" )) found =TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "gtell" )) found =TRUE;
  		else if (!str_cmp( cmd_table[cmd].name, ";" )) found =TRUE;
		else
                 {
		...
		else if (!str_cmp( cmd_table[cmd].name, "umbralvision" )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "umbra" )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "regenerate" )) found = TRUE;
		...
		else if (!str_cmp( cmd_table[cmd].name, "earthmeld" )) found = TRUE;
		else {
...
*/
    ...
    if ( arg[0] == '\0' )
    {
	act4( social_table[cmd].others_no_arg, ch, NULL, victim, TO_ROOM);
	act4( social_table[cmd].char_no_arg,   ch, NULL, victim, TO_CHAR);
    }
    ...
    {
	act4( social_table[cmd].others_auto,   ch, NULL, victim, TO_ROOM);
	act4( social_table[cmd].char_auto,     ch, NULL, victim, TO_CHAR);
    }
    else
    {
	act4( social_table[cmd].others_found,  ch, NULL, victim, TO_NOTVICT );
	act4( social_table[cmd].char_found,    ch, NULL, victim, TO_CHAR);
	act4( social_table[cmd].vict_found,    ch, NULL, victim, TO_VICT);
...
/*
			if (!strcmp(xsocial_table[cmd].name, "xgag"))
                  {
				if (!IS_SET(victim->extra, GAGGED))
					SET_BIT(victim->extra, GAGGED);
			}
			if (!strcmp(xsocial_table[cmd].name, "xblind"))
                  {
				if (!IS_SET(victim->extra, BLINDFOLDED))
					SET_BIT(victim->extra, BLINDFOLDED);
				if (IS_SET(victim->act, PLR_HOLYLIGHT))
					REMOVE_BIT(victim->act, PLR_HOLYLIGHT);
			}
			if (!strcmp(xsocial_table[cmd].name, "xtie"))
                  {
				SET_BIT(victim->extra,TIED_UP);
				victim->pcdata->partner = victim;
				send_to_char("(CONSENT ALL SET)\n\r", victim);
			}
*/
